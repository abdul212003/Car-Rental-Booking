                        ...
                        <tbody>
                            @forelse($cars as $car)
                                <tr>
                                    ...
                                    <td><strong>{{ $car->brand }}</strong><br><small
                                            class="text-muted">{{ $car->model }}</small></td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $car->status == 'available' ? 'success' : 'danger' }}">
                                            {{ ucfirst($car->status) }}
                                        </span>
                                    </td>
                                    <td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Cars Modal</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form wire:submit.prevent="createCars">
                             <div class="row g-3">
                            <!-- Basic Information -->
                            <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" wire:click="createCars">Save</button>
                    </div>
                        </form>
                </div>
            </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="file" class="form-control"
                                                    wire:model="interior_image" accept="image/*">
                                                @error('interior_image')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label">Additional Image</label>
                                                <input type="file" class="form-control"
                                                    wire:model="additional_image" accept="image/*">
                                                @error('additional_image')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
